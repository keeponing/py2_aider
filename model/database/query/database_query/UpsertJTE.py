	...
	try:
		...
		if 0 ==  count: 
			...
			cmd = f"""
					...
					where 
							te_id='{te.get('te_id',0)}'
						and
							te_race='{te.get('te_race',0)}'
						and
...
def create_update_sql_1(dct):
	ret = f'''
		UPDATE  {const.TBL_KJDB_TE_CACHE_VALIABLE}
		SET

		te_09T1823 = {dct.get('te_09T1823',0)}
		, te_07D2330 = {dct.get('te_07D2330',0)}
		, te_07T1418 = {dct.get('te_07T1418',0)}
		, te_05T1418 = {dct.get('te_05T1418',0)}
		, te_06T1418 = {dct.get('te_06T1418',0)}
		, te_99D1418 = {dct.get('te_99D1418',0)}
		, te_06D2330 = {dct.get('te_06D2330',0)}
		, te_99T1418 = {dct.get('te_99T1418',0)}
		, te_08T1823 = {dct.get('te_08T1823',0)}
		, te_02T2330 = {dct.get('te_02T2330',0)}
		, te_02D2330 = {dct.get('te_02D2330',0)}
		, te_10D1418 = {dct.get('te_10D1418',0)}
		, te_09T0714 = {dct.get('te_09T0714',0)}
		, te_03D1418 = {dct.get('te_03D1418',0)}
		, te_99T1823 = {dct.get('te_99T1823',0)}
		, te_10T30OV = {dct.get('te_10T30OV',0)}
		, te_05T1823 = {dct.get('te_05T1823',0)}
		, te_09D0714 = {dct.get('te_09D0714',0)}
		, te_09T2330 = {dct.get('te_09T2330',0)}
		, te_01D0714 = {dct.get('te_01D0714',0)}
		, te_10D2330 = {dct.get('te_10D2330',0)}
		, te_05D1418 = {dct.get('te_05D1418',0)}
		, te_05D1823 = {dct.get('te_05D1823',0)}
		, te_10D0714 = {dct.get('te_10D0714',0)}
		, te_03T2330 = {dct.get('te_03T2330',0)}
		, te_08D0714 = {dct.get('te_08D0714',0)}
		, te_06T2330 = {dct.get('te_06T2330',0)}
		, te_03T1418 = {dct.get('te_03T1418',0)}
		, te_99T0714 = {dct.get('te_99T0714',0)}
		, te_08T0714 = {dct.get('te_08T0714',0)}
		, te_05T0714 = {dct.get('te_05T0714',0)}
		, te_99T30OV = {dct.get('te_99T30OV',0)}
		, te_02T1823 = {dct.get('te_02T1823',0)}
		, te_01T1823 = {dct.get('te_01T1823',0)}
		, te_07T0714 = {dct.get('te_07T0714',0)}
		, te_02T0714 = {dct.get('te_02T0714',0)}
		, te_09D1418 = {dct.get('te_09D1418',0)}
		, te_06T30OV = {dct.get('te_06T30OV',0)}
		, te_08T2330 = {dct.get('te_08T2330',0)}
		, te_09D1823 = {dct.get('te_09D1823',0)}
		, te_99D2330 = {dct.get('te_99D2330',0)}
		, te_10T2330 = {dct.get('te_10T2330',0)}
		, te_06T1823 = {dct.get('te_06T1823',0)}
		, te_09T1418 = {dct.get('te_09T1418',0)}
		, te_03T0714 = {dct.get('te_03T0714',0)}
		, te_03D2330 = {dct.get('te_03D2330',0)}
		, te_06D0714 = {dct.get('te_06D0714',0)}
		, te_99D0714 = {dct.get('te_99D0714',0)}
		, te_07D1418 = {dct.get('te_07D1418',0)}
		, te_03D0714 = {dct.get('te_03D0714',0)}
		, te_07T2330 = {dct.get('te_07T2330',0)}
		, te_99D30OV = {dct.get('te_99D30OV',0)}
		, te_04D2330 = {dct.get('te_04D2330',0)}
		, te_07T30OV = {dct.get('te_07T30OV',0)}
		, te_06T0714 = {dct.get('te_06T0714',0)}
		, te_08D1823 = {dct.get('te_08D1823',0)}
		, te_04T30OV = {dct.get('te_04T30OV',0)}
		, te_06D1418 = {dct.get('te_06D1418',0)}
		, te_07D0714 = {dct.get('te_07D0714',0)}
		, te_01D2330 = {dct.get('te_01D2330',0)}
		, te_02D1418 = {dct.get('te_02D1418',0)}
		, te_04D1418 = {dct.get('te_04D1418',0)}
		, te_01T1418 = {dct.get('te_01T1418',0)}
		, te_03T1823 = {dct.get('te_03T1823',0)}
		, te_08D1418 = {dct.get('te_08D1418',0)}
		, te_01D1418 = {dct.get('te_01D1418',0)}
		, te_04T1823 = {dct.get('te_04T1823',0)}
		, te_10T1418 = {dct.get('te_10T1418',0)}
		, te_01T2330 = {dct.get('te_01T2330',0)}
		, te_05D0714 = {dct.get('te_05D0714',0)}
		, te_07T1823 = {dct.get('te_07T1823',0)}
		, te_04T2330 = {dct.get('te_04T2330',0)}
		, te_99D1823 = {dct.get('te_99D1823',0)}
		, te_02D0714 = {dct.get('te_02D0714',0)}
		, te_10T0714 = {dct.get('te_10T0714',0)}
		, te_04D0714 = {dct.get('te_04D0714',0)}
		, te_08T30OV = {dct.get('te_08T30OV',0)}
		, te_04T1418 = {dct.get('te_04T1418',0)}
		, te_02T1418 = {dct.get('te_02T1418',0)}
		, te_03T30OV = {dct.get('te_03T30OV',0)}
		, te_08T1418 = {dct.get('te_08T1418',0)}
		, te_07D1823 = {dct.get('te_07D1823',0)}
		, te_99T2330 = {dct.get('te_99T2330',0)}
		, te_04T0714 = {dct.get('te_04T0714',0)}
		, te_09T30OV = {dct.get('te_09T30OV',0)}
		, te_01T0714 = {dct.get('te_01T0714',0)}
		, te_10T1823 = {dct.get('te_10T1823',0)}
		, te_05T30OV = {dct.get('te_05T30OV',0)}
		, te_05T2330 = {dct.get('te_05T2330',0)}
		, te_05D2330 = {dct.get('te_05D2330',0)}
		, te_bpdjy = {dct.get('te_bpdjy',0)}
		, te_bpdsy = {dct.get('te_bpdsy',0)}
		, te_bpdty = {dct.get('te_bpdty',0)}
		, te_bpds = {dct.get('te_bpds',0)}
		, upd = {dct.get('upd',0)}
		WHERE
		te_horse_id = '{dct.get('te_horse_id',0)}'
		and te_race = '{dct.get('te_race',0)}' 
		and te_id = '{dct.get('te_id',0)}'		
				
	'''
	return ret


def create_update_sql_2(dct):
	ret = f'''
		UPDATE  {const.TBL_KJDB_TE_CACHE_VALIABLE}
		SET
		 te_D0714 = {dct.get('te_D0714',0)}
		, te_D1418 = {dct.get('te_D1418',0)}
		, te_D1823 = {dct.get('te_D1823',0)}
		, te_D2330 = {dct.get('te_D2330',0)}
		, te_D30OV = {dct.get('te_D30OV',0)}
		, te_T0714 = {dct.get('te_T0714',0)}
		, te_T1418 = {dct.get('te_T1418',0)}
		, te_T1823 = {dct.get('te_T1823',0)}
		, te_T2330 = {dct.get('te_T2330',0)}
		, te_T30OV = {dct.get('te_T30OV',0)}
		, te_bpdjy = {dct.get('te_bpdjy',0)}
		, te_bpdsy = {dct.get('te_bpdsy',0)}
		, te_bpdty = {dct.get('te_bpdty',0)}
		, te_bpds = {dct.get('te_bpds',0)}
		, te_000000000000000 = {dct.get('te_000000000000000',0)}
		, te_000000000000703 = {dct.get('te_000000000000703',0)}
		, te_000000000000999 = {dct.get('te_000000000000999',0)}
		, te_000000000999999 = {dct.get('te_000000000999999',0)}
		, te_000000005005005 = {dct.get('te_000000005005005',0)}
		, te_000000005010005 = {dct.get('te_000000005010005',0)}
		, te_000000009018009 = {dct.get('te_000000009018009',0)}
		, te_000000010010010 = {dct.get('te_000000010010010',0)}
		, te_000000010020010 = {dct.get('te_000000010020010',0)}
		, te_000000016016016 = {dct.get('te_000000016016016',0)}
		, te_000000016032016 = {dct.get('te_000000016032016',0)}
		, te_000000703703703 = {dct.get('te_000000703703703',0)}
		, te_000000999000999 = {dct.get('te_000000999000999',0)}
		, te_000000999999999 = {dct.get('te_000000999999999',0)}
		, te_000005000000005 = {dct.get('te_000005000000005',0)}
		, te_000005005005005 = {dct.get('te_000005005005005',0)}
		, te_000005010010005 = {dct.get('te_000005010010005',0)}
		, te_000009000000009 = {dct.get('te_000009000000009',0)}
		, te_000009018018009 = {dct.get('te_000009018018009',0)}
		, te_000010000000010 = {dct.get('te_000010000000010',0)}
		, te_000010010010010 = {dct.get('te_000010010010010',0)}
		, te_000010020020010 = {dct.get('te_000010020020010',0)}
		, te_000016016016016 = {dct.get('te_000016016016016',0)}
		, te_000016032032016 = {dct.get('te_000016032032016',0)}
		, te_000701000000701 = {dct.get('te_000701000000701',0)}
		, te_000702000000702 = {dct.get('te_000702000000702',0)}
		, te_000703000000703 = {dct.get('te_000703000000703',0)}
		, te_000703703703703 = {dct.get('te_000703703703703',0)}
		, te_000999000000999 = {dct.get('te_000999000000999',0)}
		, te_000999999999999 = {dct.get('te_000999999999999',0)}
		, te_005000000000005 = {dct.get('te_005000000000005',0)}
		, te_701000000000701 = {dct.get('te_701000000000701',0)}
		, te_703000000000703 = {dct.get('te_703000000000703',0)}
		, te_999000000000999 = {dct.get('te_999000000000999',0)}
		, te_C2_00 = {dct.get('te_C2_00',0)}
		, te_C2_01 = {dct.get('te_C2_01',0)}
		, te_C2_02 = {dct.get('te_C2_02',0)}
		, te_C2_03 = {dct.get('te_C2_03',0)}
		, te_C2_04 = {dct.get('te_C2_04',0)}
		, te_C2_05 = {dct.get('te_C2_05',0)}
		, te_C2_06 = {dct.get('te_C2_06',0)}
		, upd = {dct.get('upd',0)} 
		WHERE
		te_horse_id = '{dct.get('te_horse_id',0)}'
		and te_race = '{dct.get('te_race',0)}' 
